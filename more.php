...
<div style="padding-left:10px;padding-top:10px">
			<strong>当前位置:</strong> <span><a href="http://zzb.sdau.edu.cn/">组织部首页</a>><a href="index.php">推荐读书</a>>往期推荐</span>
		</div>
	<!-- foot -->
	<div class="cb"></div> 
	<p class="text-left" style="color:#6B0000;font-size:24px;font-family:'Microsoft YaHei';padding:10px">往期推荐</p>
		<hr style="height:4px;background-color:#bd460e;" />
		<?php if($i==0) 
				echo "<center><h3>暂无往期推荐</h3></center>";
		else{
			?>
